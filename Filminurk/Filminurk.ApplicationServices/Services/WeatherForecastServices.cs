...
namespace Filminurk.ApplicationServices.Services
{
    public class WeatherForecastServices : IWeatherForecastServices
    {
        ...
        { 
            string apiKey = Data.Environment.accuweatherkey; //key tuleb environment failist
            ...
            { 
                ...
                var response = await httpClient.GetAsync($"{dto.CityCode}?apikey={apiKey}&detail=true");
